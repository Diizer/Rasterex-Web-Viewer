...
const dbConfig: DBConfig = {
  ...
  version: 1,
  objectStoresMeta: [
    { store: 'CustomStamp', storeConfig: { keyPath: 'id', autoIncrement: true }, storeSchema },
    { store: 'UploadStamp', storeConfig: { keyPath: 'id', autoIncrement: true }, storeSchema },
  ],
};
...
@NgModule({
  ...
  providers: [ColorHelper, Title, provideHttpClient(withInterceptorsFromDi())],
})
