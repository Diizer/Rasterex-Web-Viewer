...
export class QuickActionsMenuComponent implements OnInit, OnDestroy {
  ...
  private _setButtons(): void {
    ...
    if (
      (this.annotation.type === 1 && this.annotation.subtype === 3) ||
      (this.annotation.type === 3 && this.annotation.subtype === 6) ||
      this.annotation.type === 7 ||
      this.annotation.type === 8
    ) {
  ...
  ngOnInit(): void {
    this.guiMarkupSubscription = this.rxCoreService.guiMarkup$.subscribe(({ markup, operation }) => {
      ...
      this.havepointinsert =
        (this.annotation.type == 1 && (this.annotation.subtype == 1 || this.annotation.subtype == 2 || this.annotation.subtype == 3)) ||
        this.annotation.type === 13 ||
        this.annotation.type === 8 ||
        (this.annotation.type === 3 && this.annotation.subtype === 6);
      this.havepointdelete =
        (this.annotation.type == 1 && (this.annotation.subtype == 1 || this.annotation.subtype == 2 || this.annotation.subtype == 3)) ||
        this.annotation.type === 13 ||
        this.annotation.type === 8;
