...
export class ScaleDropdownComponent implements OnInit, OnDestroy {
  ...
  get selectedScaleLabel(): string {
    ...
    if (metric === '1') {
      ...
      right =
        this.selectedScale.value && this.selectedScale.value.includes(':')
          ? this.selectedScale.value.split(':')[1]
          : this.selectedScale.customScaleValue || '';
      ...
      left =
        this.selectedScale.value && this.selectedScale.value.includes(':')
          ? this.selectedScale.value.split(':')[0]
          : this.selectedScale.pageScaleValue || '';
      right =
        this.selectedScale.value && this.selectedScale.value.includes(':')
          ? this.selectedScale.value.split(':')[1]
          : this.selectedScale.customScaleValue || '';
