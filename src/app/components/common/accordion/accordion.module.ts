...
@NgModule({
  declarations: [AccordionComponent, AccordionItem, AccordionContent, AccordionHeader, AccordionToggleButtonComponent],
  imports: [CommonModule],
  exports: [AccordionComponent, AccordionItem, AccordionContent, AccordionHeader, AccordionToggleButtonComponent],
})
