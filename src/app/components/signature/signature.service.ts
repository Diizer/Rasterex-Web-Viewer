...
export class SignatureService {
  ...
  public adoptSignatureOpened: BehaviorSubject<{ opened: boolean; mode: 'create' | 'editSignature' | 'editInitials' }> = new BehaviorSubject<{
    opened: boolean;
    mode: 'create' | 'editSignature' | 'editInitials';
  }>({ opened: false, mode: 'create' });
  public adoptSignatureOpened$: Observable<{ opened: boolean; mode: 'create' | 'editSignature' | 'editInitials' }> =
    this.adoptSignatureOpened.asObservable();
